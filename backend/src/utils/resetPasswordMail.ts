    ...
    <html>
      ...
      <body style="margin: 0; padding: 0; font-family: 'Arial', sans-serif; background-color: #f4f4f4;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px 20px;">
          <h1 style="margin: 0 0 15px 0; padding: 0; font-size: 24px;">Password Reset Request</h1>
          <p style="margin: 0 0 10px 0; padding: 0;">Hello <strong>${username}</strong>,</p>
          <p style="margin: 0 0 15px 0; padding: 0;">We received a request to reset your password. Click the button below to create a new password:</p>
          ...
          <p style="color: #666; font-size: 14px; margin: 15px 0 0 0; padding: 0;">This link will expire in <strong>1 hour</strong>.</p>
