  ...
  <body style="margin: 0; padding: 0; font-family: 'Arial', sans-serif; background-color: #f4f4f4;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px 20px;">
      ...
      <div style="text-align: center; color: #666666;">
        <p style="font-size: 18px; color: #333333; margin: 0 0 15px 0; padding: 0;">Hello <strong>${username}</strong>,</p>
        <p style="font-size: 16px; margin: 0 0 20px 0; padding: 0; line-height: 1.4;">
          Thank you for signing up! Please use the verification code below to complete your registration.
        </p>
        <div style="background: #1a1a1a; border-radius: 8px; padding: 20px; margin: 20px 0; border: 2px solid #e0e0e0;">
          ...
          <p style="color: #cccccc; font-size: 13px; margin: 10px 0 0 0; padding: 0; opacity: 0.9;">Click to select and copy</p>
        </div>
        ...
        <p style="font-size: 14px; color: #666666; margin: 15px 0; padding: 0; line-height: 1.4;">
          Enter this code on the verification page to activate your account.
        </p>
        <p style="color: #dc3545; font-size: 14px; margin: 15px 0 0 0; padding: 0;">
