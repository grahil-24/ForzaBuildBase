            ...
            return (
              <div key={index} className='cursor-pointer relative flex items-center border border-gray-200 bg-white hover:shadow-lg transition-shadow duration-200 overflow-hidden'>
                ...
                <div className='absolute top-2 right-2 sm:top-3 sm:right-16 md:right-20'>
                  <span className={`inline-block px-2 py-0.5 sm:px-3 sm:py-1 ${rank_to_color[tune.tune.resultant_rank as RankType]} text-white text-[10px] sm:text-xs md:text-sm font-bold shadow-md`}>
                ...
                <div className='flex items-center pr-3 md:pr-4'>
                  <Menu as="div" className="relative">
                    ...
                    <MenuItems
                      ...
                      modal={false}
                      anchor="bottom end"
                      className="absolute right-0 mt-2 w-40 sm:w-48 bg-white border border-gray-200 shadow-xl overflow-hidden z-50 focus:outline-none transition duration-100 ease-out data-closed:scale-95 data-closed:opacity-0"
                    >
